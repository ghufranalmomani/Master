...
<body>
    <div class="pop" style="display: <?php echo $non; ?>;">
        <div class="mess">
            Your Order is Placed! Thank You for Buying from Just For You.
        </div>
    </div>
                ...
                <div class="side2">
                    ...
                    <table>
                        ...
                        if ($resultcheck4 > 0) {
                            ...
                            while ($row4 = mysqli_fetch_assoc($query4)) {
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; width: 30%;">JD' . $row4["price"] . '</td>
                                    <td style="text-align: right;">JD' . ($row4["quantity"] * $row4["price"]) . '</td>
                                </tr>';
                                // $i++;
                            }
                        }
                        ...
                        <tr>
                            ...
                            <th style="text-align: right;" colspan="3">JD<?php echo $total; ?></th>
                        </tr>
                    </table>
                    <div>
